...
If you want to reproduce it yourself (without ill intent), know that I was using an amd 7700xt GPU and amd 7700 CPU with 32Gb DDR5 ram for inference. And for training I was using a laptop with and rtx 3050 and 16Gb of ram. If you're using something else (especially a smaller gpu or nvdia) you might need to adjust the code for the following. Also, try to keep the same resolution in game, in my case I chose low settings.
